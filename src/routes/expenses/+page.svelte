...
<style>
  ...
  .row { display: grid; grid-template-columns: 190px minmax(220px, 1fr) 170px 100px; gap: var(--sp-3); align-items: end; padding: var(--sp-3) var(--sp-4); border-bottom: 1px solid var(--border); }
